...
3. **Products** (`/products`) - Overview of three specialized solutions
4. **Product Pages:**
   - LuminaIQ (`/products/lumina-iq`) - AI learning platform
   - Tabble (`/products/tabble`) - Premium dining solution
...
2. WorkShowcase - Interactive portfolio gallery
...
**Unique Features:**
1. **Live Embed Section**
   - Embedded LuminaIQ demo
   - Full-width iframe
...
**CTA:** Join the Waitlist (primary gold button)

**Purpose:** Detailed product page for LuminaIQ AI learning platform with interactive demo and waitlist signup.
...
**Purpose:** Dedicated page for Tabble premium dining solution showing features and benefits for restaurants/hotels.
...
**Features:**
- Main display: Large image with 3D rotation
- Mouse movement triggers parallax rotation
- Auto-play carousel (5s interval)
- Thumbnail navigation (vertical on desktop)
- Counter badge shows X/Y
- Navigation arrows (left/right)
- Active thumbnail has gold ring
